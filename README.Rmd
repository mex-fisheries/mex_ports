...
### How the data are built
	...
	The information in mex_large_scale_landing_ports.csv is from ____ and was extracted through by _____. 
...
- municipality_id: numeric. 5-digit numeric code that acts as a unique identifier for each 
- municipality. 
