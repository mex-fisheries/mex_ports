...
The inputs for  ‘landing_site_id’ are originally labeled as ___ in ___

mex_ports_dictionary.csv was created to find the overlap of ports between these two files. This file connected the ports that contained the same or very similar names (ex, a port in one data set omitted accents while the other did not). 
